...
namespace SampleBinaryClassification.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"/Users/mike/Code/AI/MLNET/myMLApp/wikipedia-detox-250-line-data.tsv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options() { L2Regularization = 0.495046f, L1Regularization = 0.3978319f, OptimizationTolerance = 1E-07f, HistorySize = 5, MaximumNumberOfIterations = 989990667, InitialWeightsDiameter = 0.5895279f, DenseOptimizer = true, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });

...
namespace SampleRegression.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"/Users/mike/Code/AI/MLNET/myMLApp/taxi-fare-train.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.Regression.Trainers.FastTreeTweedie(new FastTreeTweedieTrainer.Options() { NumberOfLeaves = 96, MinimumExampleCountPerLeaf = 10, NumberOfTrees = 500, LearningRate = 0.08892966f, Shrinkage = 0.1897559f, LabelColumnName = "fare_amount", FeatureColumnName = "Features" });
